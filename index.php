            ...
            <div id="prijemni_ispit">
                <div id="prijemni_ispit_tekst">
                    ...
                    <div id="prijemni_ispit_opis">
                        <br>
                        Лекције за пријемне испите структуриране су на систематичан начин како би 
...
Академска мисао, Београд 2015.</i>
Материјали су подељени у 16 различитих области којим је покривено
целокупно градиво потребно за припрему пријемног испита.
Материјали за пријемни испит из физике су и даље у припреми. На индивидуалним часовим за пријемни испит 
            ...
            <div id="takmicenja">
                ...
                <div id="takmicenja_tekst">
                    ...
                    <div id="takmicenja_opis">
                        <br>Лекције за такмичења снимане су према гимназијском плану и програму и усклађене
...
Ове лекције су намењене средњошколцима свих разреда и дизајниране су за припрему
свих нивоа такмичења (општинско, окружно, републичко).
Садрже детаљна објашњења захтевнијих задатака и примера из претходних година такмичења,
    ...
    <div id="o_meni">
        ...
        <div id="o_meni_content">
            <p id="o_meni_1">Поздрав! Моје име је Илија Савић, дипломирани сам инжењер
                ...
                једној домаћој компанији.  <br><br>Још у основној и средњој школи учествовао сам на бројним
                такмичењима из математике и физике и освајао награде на републичким такмичењима, а
                у четвртом разреду сам се пласирао на Српску физичку олимпијаду. Електротехнички факултет 
                сам уписао без полагања пријемног испита као један од петоро студената у генерацији који
                су имали награде са републичких такмичења и из математике и из физике.   <br><br>Током основне и 
                средње школе, а касније и на факултету, волео сам да помажем вршњацима и млађим друговима
                и колегама. Жеља за преношењем знања из области математике и физике довела ме је до 
        ...
        <div id="privatni_casovi_final">
            <div id="contact">
                ...
                <div id="logo_again">
                    ...
                    <i>Рачунај на успех!</i>
                </div>
                <div id="contact_info">
                        <div id="contact_naslov">Контакт</div>
                    <div id="privatni_casovi_p1" style="padding-left: 100px;">Уколико су вам потребни приватни часови
                         или ако имате неких питања, слободно ме контактирајте:</div>
